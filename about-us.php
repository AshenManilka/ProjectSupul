        ...
        <div class="row">
            ...
            <div class="col-lg-6 order-1">
                <div class="about-info-wrapper">
                    <h2>Our company</h2>
                    <p>Supul is renowned for its exceptional trading in high quality garments for 28 years. As a reputable company, we have gained credence for our excellent customer service from people at all ages. Our company has expanded the divergent service across Malabe, Kaduwela, Hanwella, Mulleriyawa outlets and as a leading fashion retailer in Colombo we strive to accomplish our moral principles everyday.</p>
...
<div id="locations" class="About-us-team-area border-bottom">
            ...
            <div class="container">
                <div class="row">            
                    ...
                    <div class="col-lg-3">
                        <h2>Malabe</h2>
                        <p>
                            867/12 Kaduwela Road, Malabe <br>
                            Tel - 0114377521
                        </p>
                    </div>
                    <div class="col-lg-3">
                        <h2>Kaduwela</h2>
                        <p>
                            483/2 Awissawella Road, Kaduwela <br>
                            Tel - 0114377520
                        </p>
                    </div>
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-3">
                        <h2>Mulleriyawa</h2>
                        <p>
                            52, Hospital Road, Mulleriyawa New Town <br>
                            Tel - 0114377523
                        </p>
                    </div>
                </div>
                 <div class="row">
                   ...
                   <div class="col-lg-12 col-md-12 m-auto ">
                        <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1DBgAoeEgI2lJHaNTklKpMNixQsmDJy3d" width="100%" height="480"></iframe>
                   </div>
                </div>
            </div>
    </div>
